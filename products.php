...
$stmt = $link->prepare('SELECT id,title,description,terms,price FROM products WHERE id = ' . $_GET['id']);
$stmt->execute();

$stmt->bind_result($id, $title, $description, $terms, $price);
	...
	<body class="loggedin">
		...
		<div class="content">
			...
			<div class="btns">
				<div class="product">
					<div class="card">
						<img src='productpictures/<?=$id?>.jpg' style='width:100%'>
						...
						<form action="" method="post">
							<?php
								if(isset($_POST['submit'])) {
									echo '<input type="submit" id="submits" name="submits" value="Are you sure?">';
								} else {
									echo '<input type="submit" id="submit" name="submit" value="Buy">';
								}
						...
						<div class='buttons'>
							<span><a href='products.php?id=<?=$id?>'>Description</a></span>
							<span><a href='products.php?id=<?=$id?>&terms=true'>Terms & Conditions</a></span>
						</div>
						<?php 
							if(isset($_GET['terms'])) {
								echo nl2br("<div class='terms'>".$terms."</div>");
							} else {
								echo nl2br("<div class='description'>".$description."</div>");
							}
