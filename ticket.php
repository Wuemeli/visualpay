...
<div class="content home">
	...
	<p>Create a Ticket, if you need Support.</p>

	<div class="btns">
		<a href="createticket.php" class="btn">Create Ticket</a>
	</div>

	<div class="tickets-list">
		<?php foreach ($tickets as $ticket): ?>
			<?php if($ticket['username'] == $_SESSION["username"] || $_SESSION["rank"] == 'admin'): ?>
				<a href="view.php?id=<?=$ticket['id']?>" class="ticket">
					...
					<span class="user"><?=htmlspecialchars($ticket['username'], ENT_QUOTES)?></span>
