		...
		<div class="content">
			...
			<h2>Withdraw</h2>
				...
				<div class="content create">
					...
					<label>Balance: <?php echo number_format($balance, 2) ?>$</label>
					
					<br>
					<br>
					
					<form action="payout-deposit/payout.php" method="post">
					
						<input type="number" placeholder='Amount' id='amount' name='amount' min="5" max="78" step="0.01" required>
