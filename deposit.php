...
.create form input[value="Bank Transfer"], .view form input[type="submit"] {
    display: block;
...
.create form input[value="Bank Transfer"]:hover, .view form input[type="submit"]:hover {
    background-color: #656356;
}

.create form input[value="Stripe (Credit-Card, SEPA etc)"], .view form input[type="submit"] {
    display: block;
...
.create form input[value="Stripe (Credit-Card, SEPA etc)"]:hover, .view form input[type="submit"]:hover {
		...
		<div class="content">
			...
			<h2>Deposit</h2>
				...
				<div class="content create">
					...
					<form action="payout-deposit/deposit.php" method="post">
					
						<input type="number" placeholder='Amount' id='amount' name='amount' min="0.50" max="500" step="0.01" required>
						
						<input type="submit" name="action" value="PayPal">
						<input type="submit" name="action" value="Crypto">
                        <input type="submit" name="action" value="Bank Transfer">
                        <input type="submit" name="action" value="Stripe (Credit-Card, SEPA etc)">
